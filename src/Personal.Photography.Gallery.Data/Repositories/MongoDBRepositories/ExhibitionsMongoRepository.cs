...
{
    public class ExhibitionsMongoRepository : IExhibitionsMongoRepository
    {
        private MongoDBContext _context = new MongoDBContext();
        private IMongoCollection<Photograph> _collection;

        public ExhibitionsMongoRepository()
        {
            _collection = _context._database.GetCollection<Photograph>("Exhibitions");
        }
